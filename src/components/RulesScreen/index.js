    ...
    <Styled.Container>
      ...
      <ul>
        <li>
          ...
          room they will move to. They must move the number of spaces listed on
          the card.
        </li>
        <li>
          <b>Leave behind something.</b>: Choose a character to leave behind a
          Drop Token in the room they are currently in. The size and polarity of
          of the token is listed on the card. This represents something the
          ...
          that's being left. The idea is that a larger number represents a more
        ...
        <li>
          ...
          currently in. Choose which pile of Drop Tokens they'll be interacting
          with. If multiple tokens from one character are in a room, the effect
          will be the total of the tokens. The corresponding relationship will
          change that amount. This represents a character reacting to things
          another character left in the room. Again, players are encouraged to
          describe this reaction. If there are no characters in a room with
          anther character's drop tokens, the player's turn is skipped.
        </li>
        <li>
          <b>Convo (Fight/Bond)</b>: First choose whether the two characters
          you'll be selecting will fight (negatively affecting the relationship
          by one) or bond (positively affecting the relationship by 1). Choose
          the two characters that you want to interact. The two must be in the
          same room. If this is a fight, choose a character to storm off, then
          choose an adjacent room for them to storm off to. If this is a bond,
          they'll remain in the same room. Once again, players are encouraged to
          describe the specifics of the interaction. If there are no two
          characters in a room together the player's turn is skipped.
        </li>
      </ul>
      <h2>Game End</h2>
